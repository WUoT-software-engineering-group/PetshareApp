...
namespace Petshare.DataPersistence.Migrations
{
    ...
    [Migration("20230523172636_liked-announcements")]
    partial class likedannouncements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LikedAnnouncements", b =>
                {
                    b.Property<Guid>("LikedAnnouncementsID")
                    ...
                    b.HasKey("LikedAnnouncementsID", "LikedByID");

                    b.HasIndex("LikedByID");

                    b.ToTable("LikedAnnouncements");
                });
            ...
            modelBuilder.Entity("LikedAnnouncements", b =>
                {
                    b.HasOne("Petshare.Domain.Entities.Announcement", null)
                        .WithMany()
                        .HasForeignKey("LikedAnnouncementsID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Petshare.Domain.Entities.Adopter", null)
                        .WithMany()
